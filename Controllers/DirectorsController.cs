...
namespace Movie_Database_MVC.Controllers
{
    public class DirectorsController : Controller
    {
        ...
        public DirectorsController(Movie_Database_DBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Website")] Director director)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Website")] Director director)
        {
            if (id != director.Id)
            {
                return NotFound();
