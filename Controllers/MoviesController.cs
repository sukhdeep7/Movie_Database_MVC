...
namespace Movie_Database_MVC.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public MoviesController(Movie_Database_DBContext context)
        {
            _context = context;
        }
        ...
        {
            var movie_Database_DBContext = _context.Movie.Include(m => m.Director);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Genres,DirectorId,ReleaseYear")] Movie movie)
        {
            if (id != movie.Id)
            {
                return NotFound();
